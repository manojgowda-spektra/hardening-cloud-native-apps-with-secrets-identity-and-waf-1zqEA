...
## Options
Option 1 : Each proves a different control: HTTP results prove request behavior, the WAF log attributes the block to `Block-ZavaAttack-Header`, secret-source evidence proves runtime use of Key Vault, and effective-RBAC evidence proves no broader assignment still grants the legacy identity secret-value access.
